...
export const metadata: Metadata = {
  title: "AI Marketing Stacks — Pick the Right Tools for Every Campaign",
  description:
    "Pre-built tool combinations for common marketing tasks. See exactly which AI tools you need for content marketing, SEO, email automation, social media, and more.",
};
