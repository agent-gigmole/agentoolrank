...
export const metadata: Metadata = {
  title: "AI Marketing Weekly — Top Trending Marketing Tools This Week",
  description:
    "Weekly digest of the fastest-growing AI marketing tools. See what's trending in content creation, SEO, email marketing, and more.",
};
...
export default async function WeeklyPage() {
  ...
  return (
    <>
      <BreadcrumbJsonLd items={[{ label: "AI Marketing Weekly" }]} />
      <main className="max-w-4xl mx-auto px-4 py-8">
        <Breadcrumbs items={[{ label: "AI Marketing Weekly" }]} />
        ...
        <div className="text-center mb-10">
          ...
          <p className="text-gray-600 mt-2">
            The fastest-growing AI marketing tools this week, tracked across {toolCount} projects.
          </p>
        </div>
