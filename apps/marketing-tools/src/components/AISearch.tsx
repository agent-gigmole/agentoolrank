...
const t = {
  en: {
    ...
    statusAnalyzing: "Analyzing your marketing needs...",
    statusSelecting: "Selecting tools from 200+ options...",
    statusBuilding: "Building your marketing stack...",
    ...
    watchOut: "Watch Out",
    placeholderInit: "Describe your marketing goals... e.g. content marketing automation for SaaS",
    placeholderFollowUp: "Type your answer here...",
    followUpHint: "Try: \"Make it cheaper\" · \"Add an analytics layer\" · \"Focus on email\"",
  ...
  function toMarkdown(): string {
    ...
    for (const layer of stack.layers) {
      ...
      for (const tool of layer.tools) {
        md += `- **${tool.role}**: [${tool.name || tool.tool_id}](https://aimarketrank.com/tool/${tool.tool_id}) — ${tool.note}\n`;
      }
      md += "\n";
    }
    return md;
...
function generateInstruction(stack: ParsedStack): string {
  ...
  instruction += `# Generated by AIMarketRank (aimarketrank.com)\n\n`;
...
const POPULAR_QUERIES_EN = [
  "Content marketing automation stack",
