...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: "https://agentoolrank.com/blueprint",
    languages: { zh: "https://agentoolrank.com/zh/blueprint" },
  },
};
    ...
    <>
      ...
      <main className="max-w-6xl mx-auto px-4 py-8">
        ...
        <div className="mt-12 pt-8 border-t border-gray-100 text-sm text-gray-500 max-w-2xl">
          <h2 className="font-semibold text-gray-700 mb-2">What is an AI Project Blueprint?</h2>
          <p>
            An AI Project Blueprint is a curated combination of tools, frameworks, and services designed to solve
